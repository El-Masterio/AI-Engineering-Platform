...
**Currently in progress:** none. **Next up:** `M019 — API keys`. **Last completed:** `M018 — Immutable audit log`. CI stage 3 (integration) went live with M004. (Sequence deviation: M007→M008→M009 were pulled ahead of M003–M006, owner-approved — see BACKLOG.md.)
