...
**Currently in progress:** none. **Next up:** `M006 — Observability skeleton`. CI stage 3 (integration) went live with M004. (Sequence deviation: M007→M008→M009 were pulled ahead of M003–M006, owner-approved — see BACKLOG.md.)
