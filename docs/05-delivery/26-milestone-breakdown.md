...
**Currently in progress:** none. **Next up:** `M003 — CI pipeline` (the UI trio M007–M009 is complete; the sequence returns to backlog order) (sequence deviation: M007→M008→M009 pulled ahead of M003–M006, owner-approved — see BACKLOG.md).
