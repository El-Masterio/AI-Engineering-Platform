...
**Status — code complete, awaiting a Railway project.** Everything that can be verified without a cloud account has been, on the real image.
...
**Owner-gated** The deploy step, zero-downtime replacement and rollback-by-digest need a live Railway project. Setup is [§26 Staging Runbook](../04-engineering/26-staging-runbook.md) — about fifteen minutes.
