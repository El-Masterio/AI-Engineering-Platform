  ...
  function Switch({ className, ...props }, ref) {
    return (
      <SwitchPrimitive.Root
        ref={ref}
        className={cn(
          "peer inline-flex h-4.5 w-8 shrink-0 items-center rounded-full border border-transparent",
          ...
          "data-[state=unchecked]:bg-[var(--bg-hover)] data-[state=unchecked]:border-[var(--border-default)]",
      ...
      >
        <SwitchPrimitive.Thumb
          className={cn(
            "pointer-events-none block size-3.5 rounded-full bg-[var(--text-primary)] shadow-sm",
            "transition-transform duration-[--dur-fast] ease-[--ease-out] motion-reduce:transition-none",
            "data-[state=unchecked]:translate-x-0.5",
            "data-[state=checked]:translate-x-4 data-[state=checked]:bg-[var(--accent-fg)]",
          )}
        />
      </SwitchPrimitive.Root>
    );
